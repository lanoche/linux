...
int mpu_run_self_test(long *gyro, long *accel)
{
    ...
    flag=mpu_get_accel_fsr(&accel_fsr);
    if(flag)	printf("mpu_get_accel_fsr error\n");
    
    mpu_get_lpf(&lpf);
    flag=mpu_get_sample_rate(&sample_rate);
    if(flag)	printf("mpu_get_sample_rate error\n");
